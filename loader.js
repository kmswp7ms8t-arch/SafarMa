(async () => {
  ...
  function showFailure(error) {
    ...
    message.innerHTML = `<strong>SafarMa could not start.</strong><br><small>Please refresh the page. If the problem continues, close the installed app, reopen the V14 link, and clear old Safari website data.</small>`;
